    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.button2).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mediaPlayer != null) {
                    mediaPlayer.stop();
                    Toast.makeText(MainActivity.this, "음악파일 재생 중지!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        findViewById(R.id.button3).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mediaPlayer != null) {
                    ...
                    Toast.makeText(MainActivity.this, "음악파일 일시 정지!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        findViewById(R.id.button4).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mediaPlayer != null && mediaPlayer.isPlaying()) {
                    ...
                    Toast.makeText(MainActivity.this, "음악파일 다시 시작!", Toast.LENGTH_SHORT).show();
                }
            }
        });
